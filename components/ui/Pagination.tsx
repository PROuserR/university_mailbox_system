...
export default function Pagination({
  ...
  const getVisiblePages = (): number[] => {
    ...
    if (totalPages <= visiblePages) {
      // إذا كان العدد الكلي أقل من أو يساوي العدد المراد عرضه
  ...
  return (
    <div className={`p-4 border-t border-gray-100 flex flex-col sm:flex-row justify-between items-center gap-4 ${className}`}>
      {/* معلومات الصفحات */}
      {showInfo && (
