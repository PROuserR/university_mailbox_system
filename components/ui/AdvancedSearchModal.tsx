                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        {onStatusChange && (
                            <div className="col-span-2">
                                ...
                                >
                                    <option value="">الكل</option>
                                    <option value={String(CorrespondenceStatus.Draft)}>مسودة</option>
                                    <option value={String(CorrespondenceStatus.PendingApproval)}>بانتظار الموافقة</option>
                                    <option value={String(CorrespondenceStatus.Distributed)}>موزعة</option>
                                    <option value={String(CorrespondenceStatus.Signed)}>موقعة</option>
                                    <option value={String(CorrespondenceStatus.Archived)}>مؤرشفة</option>
                                </select>
                            </div>
                        )}
                    </div>
