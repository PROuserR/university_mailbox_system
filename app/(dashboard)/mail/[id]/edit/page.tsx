// app/(dashboard)/mail/[id]/edit/page.tsx
...
import MailEditPage from "@/components/mail/MailEditPage";

export default function EditMailPage() {
    ...
    return (
        <MailEditPage
            ...
            filter=""
            searchInput=""
            onBack={() => router.push(`/mail/${id}`)}
            onSuccess={() => router.push(`/mail/${id}`)}
        />
    );
}