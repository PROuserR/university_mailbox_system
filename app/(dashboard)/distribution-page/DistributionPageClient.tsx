...
import { CorrespondenceStatus, getStatusLabel, getStatusColor, getStatusEnum, isDistributable } from "@/types/api/correspondence.types";
...
export default function DistributionPageClient() {
    ...
    const handleBackNavigation = () => {
        const hasViewCorrespondences = delegatedPermissions.includes('ViewCorrespondence');
    ...
    const isDistributeDisabled = statusEnum === CorrespondenceStatus.Signed || 
            ...
            <div className="flex flex-col items-center justify-center min-h-[60vh] px-4">
                <div className="max-w-md w-full bg-white rounded-2xl shadow-lg border border-red-100 p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-6">
                        هذه المراسلة <span className="font-semibold text-red-500">{statusLabel}</span>،
            ...
            <header className="bg-white border-b border-gray-200 shadow-sm shrink-0">
                ...
                <div className="px-4 md:px-8 pb-4">
                    <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-sm">
                        ...
                        <span className="text-gray-300">|</span>
                        <div className="flex items-center gap-1.5 text-gray-500">
                            <FontAwesomeIcon icon={faUserGroup} className="text-gray-400 text-[10px]" />
                ...
                <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-end gap-3">
                    <div className="flex items-center gap-3 w-full sm:w-auto">
                        ...
                        <button
                            ...
                            disabled={distributeMutation.isPending || isDistributeDisabled || !hasAnyReceiver}
                            className={cn(
                                ...
                                distributeMutation.isPending || isDistributeDisabled || !hasAnyReceiver
